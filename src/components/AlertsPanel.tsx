...
  if (!isOpen) return null;
  ...
  // Funções de tipo removidas, pois agora é sempre 'warning'
...
                            </span>
                          </div>
                          <p className="text-sm text-card-foreground mb-2">{alert.messageDetails}</p>
...
                    >
                      <div className="flex items-start gap-3">
                        <div className="text-muted-foreground"> {/* CORRIGIDO */}
                          <AlertTriangle className="w-4 h-4" /> {/* CORRIGIDO */}
                        </div>
           <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-2">
                            <Badge variant="secondary" className="text-xs">
                              {alert.messageReason} {/* CORRIGIDO */}
                  </Badge>
                            <span className="text-xs text-muted-foreground">
                              Máquina {alert.machineId}
                            </span>
                          </div>
                          <p className="text-sm text-muted-foreground mb-2">{alert.messageDetails}</p> {/* CORRIGIDO */}
                          <div className="flex items-center gap-1 mb-3 text-xs text-muted-foreground">
                            <Clock className="w-3 h-3" />
                            {new Date(alert.startDateTime).toLocaleString('pt-BR')} {/* CORRIGIDO */}
                          </div>
                          <Button
                            size="sm"
                            variant="ghost"
